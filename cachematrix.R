# This file contains function to calculate the invest of a matrix-
# If the inverse of a specific matrix has already been calculates, intead of 
# recalculating it, the program will get it a cache defined for that purpose.
